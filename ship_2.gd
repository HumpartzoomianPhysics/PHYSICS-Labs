...
func recalculate_speed():
	var mass = $"../Mass2".value 
	var acceleration = $"../Acceleration2".value  
	
	var force = mass * acceleration
	print("Force: ", force)
	$"../f2".text = "Force: " + str(force) + "N"
...
func _on_mass_2_value_changed(value):
...
func _on_acceleration_2_value_changed(value):
